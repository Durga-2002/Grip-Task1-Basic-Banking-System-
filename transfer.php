...
<body>
	...
	<script src="sweetalert.min.js" type="text/javascript"></script>
  <div>
    <center><img src="5.gif" alt="transaction" style="width:50px;height:50px;"></center>
    <center><h1 style="color: white;">Transaction Successful!!!<center></h1></center>
  <center><a href="Transc.php" target="_blank">View Transactions</a></center></div>
</body>
</html>
<?php
